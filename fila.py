...
#    show_graphs() # si no se le ponen argumentos, muestra las graficas de todos los servidores
#    show_graphs(14) # si se quiere visualizar la grafica de un solo servidor, no se tiene que poner en lista, el numero solo funciona
    ## para exportar tiempos de espera
#    waiting_times()
